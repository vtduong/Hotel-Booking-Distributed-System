...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Client one
		BookAction clientOne = new BookAction(args, CLIENT_MTL_ONE, EVENT_ID_ONE ,"Seminar");
		
		// Client two
		BookAction clientTwo = new BookAction(args, CLIENT_OTW_TWO, EVENT_ID_ONE ,"Seminar");
		
		// Client three
		BookAction clientThree = new BookAction(args, CLIENT_MTL_THREE, EVENT_ID_ONE ,"Seminar");
		
		// Client four
		BookAction clientFour = new BookAction(args, CLIENT_TOR_ONE, EVENT_ID_TWO ,"Seminar");
		CancelAction clientFourCancel = new CancelAction(args, CLIENT_TOR_ONE, EVENT_ID_TWO ,"Seminar");
		SwapAction clientFourSwap = new SwapAction(args, CLIENT_TOR_ONE, EVENT_ID_TWO ,"Seminar", EVENT_ID_THREE ,"Seminar");
...
class BookAction implements Runnable {
	...
	public BookAction(String[] args, String cusID, String eventID, String eventType) {
		this.args = args;
		this.cusID = cusID;
	...
	private  void connectServer(String[] args, String cusID, String eventID, String eventType) {
		//create a logger for this client
		Logger logger = new Logger(cusID, true);
		try {
			String hostName = cusID.substring(0, 3);
...
class CancelAction implements Runnable {
	...
	public CancelAction(String[] args, String cusID, String eventID, String eventType) {
		this.args = args;
		this.cusID = cusID;
		this.eventID = eventID;
		this.eventType = eventType;
	...
	class SwapAction implements Runnable {
		...
		public SwapAction(String[] args, String cusID, String oldEventID, String oldEventType, String newEventID, String newEventType) {
			this.args = args;
			this.cusID = cusID;
		...
		private  void connectServer(String[] args, String cusID, String oldEventID, String oldEventType, String newEventID, String newEventType) {
			//create a logger for this client
			Logger logger = new Logger(cusID, true);
			try {
				String hostName = cusID.substring(0, 3);
